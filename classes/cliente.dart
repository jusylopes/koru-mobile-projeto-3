...
class Cliente extends Pessoa {
  ...
  void verResumo() {
    print(
        "O valor Total gasto foi de ${calcularTotalGasto().toStringAsFixed(2)} e valor médio gasto pelas compras foi de ${calcularMediaProdutosComprados().toStringAsFixed(2)}");
  }
}
